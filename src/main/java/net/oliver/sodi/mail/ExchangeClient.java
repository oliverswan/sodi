...
public class ExchangeClient {
    ...
    public static void main(String[] args) {
        ExchangeClient client = new ExchangeClient.ExchangeClientBuilder()
                .hostname("sodirentalkarts.com.au")
                .exchangeVersion(ExchangeVersion.Exchange2010_SP2)
                .domain("ActiveDirectoryDomain")
                .username("info@sodirentalkarts.com.au")
                .password("Maiyang9")
                .recipientTo("oliver_reg@126.com")
...
//                .recipientBcc("recipient@whatever.com") // Ignore it in case you will not use Bcc recipients.
                .attachments("d:/aaa.pdf") // Ignore it in case you will not use attachements.
